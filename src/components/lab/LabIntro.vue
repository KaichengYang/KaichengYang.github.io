...
<template>
  <div>
    <div class="gap-4 mt-4">
      <h1 class="text-4xl font-medium mb-4 flex justify-center">Welcome to Yang Lab @ Binghamton University</h1>
      <!-- lab description -->
      <div id="lab_description" class="mt-2 mx-4 prose">
        <p>
        ...
        <p>
          ...
          Our work has been <a class="link" href="#media">featured</a> in various media outlets, and you may find our <a class="link" href="#tools">research tools</a> and <a class="link" href="#datasets">datasets & benchmarks</a> helpful for your own projects.
