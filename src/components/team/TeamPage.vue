    ...
    <div class="flex flex-col flex-grow">
        ...
        <div class="container mx-auto max-w-screen-lg flex-grow">
            ...
            <div class="flex justify-center mt-12 mb-8">
                <div class="max-w-2xl w-full rounded-box bg-base-200 px-6 py-4 text-center">
                    ...
                    <div class="text-sm mt-1">
                        ...
                        <router-link to="/prospective" class="link"
                            >here</router-link
                        >
                        for more information on how to join our lab.
                    </div>
                </div>
            </div>
            ...
            <template v-if="alumniGroups.length > 0">
                ...
                <div class="mb-8">
                    <h2
                        class="text-3xl font-medium mb-6 text-center text-primary"
                    >
                        Alumni
                    </h2>

                    <div
                        v-for="group in alumniGroups"
                        :key="group.category"
                        class="mb-6"
                    >
